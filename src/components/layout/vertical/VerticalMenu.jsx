...
const VerticalMenu = ({ dictionary, scrollMenu }) => {
  ...
  return (
    ...
    >
      <MenuSection >
        <MenuItem href={`/${locale}/apps/live-token-overview`} icon={<i className='tabler-eye' />}>
          {/* Live Token Overview */}

          {dictionary['navigation'].LiveTokenOverview}
        </MenuItem>
        <MenuItem href={`/${locale}/apps/My-Trade-info`} icon={<i className='tabler-briefcase' />}>
          {/* My Trade Info */}
        ...
        <MenuItem href={`/${locale}/apps/System-Monitor`} icon={<i className='tabler-device-desktop' />}>
          {/* System Monitor */}
          {dictionary['navigation'].SystemMonitor}
        </MenuItem>
        <MenuItem href={`/${locale}/apps/manual-control`} icon={<i className='tabler-manual-gearbox' />}>
          {/* Manual Controls */}
          {dictionary['navigation'].ManualControls}
        </MenuItem>
      </MenuSection>
    </Menu>
  )
